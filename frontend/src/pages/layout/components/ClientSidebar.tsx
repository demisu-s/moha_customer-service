...
export function ClientSidebar() {
  ...
  return (
    <aside className="w-[250px] h-screen bg-[#1891C3] text-white flex flex-col justify-between px-4 py-6">
      <div>
        {/* Logo */}
      ...
      <button
        ...
        className="flex items-center justify-between bg-white text-[#1891C3] px-4 py-3 rounded-lg font-semibold hover:bg-gray-100 transition"
      >
        Logout
        <FaSignOutAlt />
      </button>
